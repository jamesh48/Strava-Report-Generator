...
const clientConfig = {
  ...
  resolve: {
    ...
    alias: {
      ...
      PaginationContainer: rootPath("dist/client/components/PaginationContainer"),
    ...
    new CopyPlugin({
      patterns: [
        ...
        },
        {
          ...
          to: rootPath("dist/client/components/OptionsProfile/Radios/AdditionalFilters"),
        },
        {
          from: rootPath("frontend/src/components/OptionsProfile/ProgressBar/progressBar.scss"),
