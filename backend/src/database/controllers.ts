...
export const getAllUserActivities: (accessToken: string) => Promise<ActivityStatic[]> =
  async (accessToken) => {
...
export const upsertAccessToken = async (
  newAccessTokenObj: AccessTokenAttributes
) => {
...
export const upsertRefreshToken = async (
  newRefreshTokenObj: RefreshTokenAttributes
) => {
