  ...
  return (
    <div className='detailed-entry'>
      ...
      <div className='top-activity-description'>
        ...
        <p className='top-activity-description'>{currentActivity.description}</p>
      </div>
      {/* Kudos & Comments */}
      <div id='fun-stats'>
        <div id='kudos-x'>
          <img id='kudos-img' src='/images/kudos.jpeg' />
          <h5 id='kudos-count' className='kudos'>Kudos- <p>{currentActivity.kudos_count}</p></h5>
          <h5 id='comment-count' className='kudos'>Comments- <p>{currentActivity.comment_count}</p></h5>
        </div>
        ...
        {currentActivity.average_heartrate ?
          <div id='golden-heart-rate'>
            ...
            <h5 id='avg-heart-rate' className='heart-rate'>Avg Heart Rate- <p>{`${currentActivity.average_heartrate} bpm}`}</p></h5>
            <h5 id='max-heart-rate' className='heart-rate'>Max Heart Rate- <p>{`${currentActivity.max_heartrate} bpm`}</p></h5>
          </div>
          :
          <div id='golden-heart-rate'>
            <img id='heart-rate-img' src='../../images/heartrate.png' />
        ...
        <div id='trophy-case'>
          ...
          <h5 className='achievements' id='achievement-count'>Achievement Count-
       <p>{currentActivity.achievement_count}</p>
...

        {
          currentActivity.photos.primary ?
            <img id='activity-photo' src={currentActivity.photos.primary.urls['600']}></img> : null
        }
