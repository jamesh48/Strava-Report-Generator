...
var Radios = function (props) {
    ...
    return (React.createElement("div", { id: "buttons-and-bar" },
        ...
        React.createElement(AdditionalFilters, { setTitleQuery: props.setTitleQuery, titleQuery: props.titleQuery, setFromDateQuery: props.setFromDateQuery, setToDateQuery: props.setToDateQuery }),
